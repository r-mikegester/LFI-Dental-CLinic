...
<template>
  <BaseLayout>
    ...
    <section class="bg-teal-500 py-3">
      <h3 class="font-bold text-3xl text-white text-center">Prosthodontics</h3>
    </section>
    <!-- Main content -->
    <section>
      <div class="max-w-6xl mx-auto px-6 py-24">
        <article class="grid md:grid-cols-2 max-w-4xl mx-auto mb-24">
          <div class="flex flex-col justify-center text-justify md:pl-12">
            ...
            <p class="mb-3">
              This denture is an oral prosthetic device that replace some of
          ...
          <div class="mt-6 md:mt-0">
            <img
              src="../../../assets/img/dental-services/partial-denture.jpg"
        ...
        <article class="grid md:grid-cols-2 max-w-4xl mx-auto mb-24">
          ...
          <div class="flex flex-col justify-center text-justify md:pr-12">
            <h4 class="text-2xl font-bold mb-3">Jacket Crown</h4>
            <p class="mb-3">
              A full porcelain ceramic covered crown which is used to protect
              the entire surface of a tooth. Crowns are an ideal way to rebuild
              teeth which have been broken or weakened by decay or large
              fillings.
            </p>
            <div>
              <button
        ...
        <article class="grid md:grid-cols-2 max-w-4xl mx-auto">
          <div class="flex flex-col justify-center text-justify md:pl-12">
            ...
            <p class="mb-3">
              a partial denture that is secured permanently in the mouth by
          ...
          <div class="mt-6 md:mt-0">
            <img
              src="../../../assets/img/dental-services/fixed-bridge.png"
              class="mx-auto w-full max-w-xs"
            />
          </div>
        </article>
