    ...
    <section>
      <div class="max-w-6xl mx-auto px-6 py-24">
        <article class="grid md:grid-cols-2 max-w-prose mx-auto mb-24">
          ...
          <div class="flex flex-col justify-center text-center md:pl-6">
            <h4 class="text-2xl font-bold mb-3">Oral Prophylaxis</h4>
            <p class="mb-3">
              A thorough examination of your oral health combined with a scale
              and clean and can be conducted by a dentist or a dental hygienist.
            </p>
            <div>
              <RouterLink
                ...
                :to="{
                  ...
                  query: { service: 'Oral Prophylaxis' },
                }"
              >
                Get this Service
              </RouterLink>
        ...
        <article class="grid md:grid-cols-2 max-w-prose mx-auto">
          <div class="flex flex-col justify-center text-center md:pr-6">
            ...
            <p class="mb-3">
              This can help you get your teeth back to their original function
              while also preventing further decay.
            </p>
            <div class="mb-6 md:mb-0">
              <RouterLink
                class="rounded-full px-3 py-1 uppercase border border-sky-600"
                :to="{
                  name: 'Appointments Page',
                  query: { service: 'Tooth Restoration' },
                }"
              >
                Get this Service
              </RouterLink>
          ...
          <div>
            <img
              src="../../../assets/img/dental-services/tooth-restoration.jpg"
              class="mx-auto w-full max-w-xs"
            />
          </div>
        </article>
