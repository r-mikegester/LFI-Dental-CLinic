        ...
        <article class="grid md:grid-cols-2 max-w-4xl mx-auto">
          ...
          <div class="flex flex-col justify-center text-justify md:pl-12">
            ...
            <p class="mb-3">
              ...
              color of human teeth. Whitening is often desirable when teeth
              become yellowed over time for a number of reasons, and can be
              achieved by changing the intrinsic or extrinsic color of the tooth
              enamel.
            </p>
            <div>
              <RouterLink
