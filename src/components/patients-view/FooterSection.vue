...
<template>
  <!-- Footer -->
  <footer id="footer" class="h-full py-6 pt-16 mb-10 bg-white border md:mb-0 mt-50 sm:p-6 border-t-sky-700"
    style="background-color: rgba(20, 184, 166, 0.4)">
    <div class="md:flex md:justify-center md:items-center">
      <div class="">
        <a href="#">
          <div>
            <img src="../../assets/img/lfi-logo-transparent.png" class="w-24 h-24 px-1 mx-auto" />
          </div>
          <div class="px-5 mb-10 text-2xl font-bold text-center md:mb-0 text-sky-700">
            LFI Dental Clinic
          </div>
        </a>
      </div>
      ...
      <div class="grid grid-cols-1 gap-8 sm:ml-20 sm:mr-20 sm:gap-20 sm:grid-cols-3 sm:justify-items-center">
        ...
        <div class="justify-center pb-5 text-center ">
          <h2 class="mb-4 text-lg font-bold uppercase text-sky-700 lg:text-left">
            Stay CONNECTED
          </h2>

          <ul class="flex items-center justify-center text-center text-gray-600 dark:text-gray-400">
    ...
    <div class="flex items-center justify-center p-2 mx-0">
      <span class="text-sm font-semibold text-center text-gray-500 dark:text-gray-400">© 2022.
      ...
      <span class="sticky right-0 bottom-64 lg:right-10 md:right-10">
        <BackToTop @scrolled="myFunction" class="flex bottom-64">
          <button type="button"
            ...
            <RouterLink :to="{ name: '' }" class="font-semibold hover:underline text-sky-700">
            </RouterLink>
            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd"
            ...
            <span class="sr-only">Go to top button</span>
          </button>
        </BackToTop>
      </span>
    </div>
