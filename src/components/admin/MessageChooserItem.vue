...
<template>
  ...
  >
    ...
    <div class="lg:visible">
      <span class="">{{
        new Date(message.createdAtUnixSecs * 1000).getHours()
      }}</span>
      <span class="">:</span>
      <span class="">{{
        new Date(message.createdAtUnixSecs * 1000).getMinutes()
      }}</span>
      <span class="mr-3"></span>
      <span class="">{{
        new Date(message.createdAtUnixSecs * 1000).getMonth()
      }}</span>
      <span class="">/</span>
      <span class="">{{
        new Date(message.createdAtUnixSecs * 1000).getDay()
      }}</span>
      <span class="">/</span>
      <span class="">{{
        new Date(message.createdAtUnixSecs * 1000).getFullYear()
      }}</span>
      <span class="mr-3"></span>
      <button
